...
template <> constexpr inline auto MyGL::qt_create_metaobjectdata<qt_meta_tag_ZN4MyGLE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<MyGL, qt_meta_tag_ZN4MyGLE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject MyGL::staticMetaObject = { {
    QMetaObject::SuperData::link<OpenGLContext::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4MyGLE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4MyGLE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4MyGLE_t>.metaTypes,
    nullptr
} };
...
void *MyGL::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4MyGLE_t>.strings))
