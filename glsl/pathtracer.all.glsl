...
const Sphere spheres[N_SPHERES] = Sphere[](Sphere(vec3(0, 0, 0), 1, Transform(mat4(3, 0, 0, 0, 0, 3, 0, 0, 0, 0, 3, 0, 0, 1.25, 0, 1), mat4(0.333333, 0, 0, 0, 0, 0.333333, 0, 0, 0, 0, 0.333333, 0, 0, -0.416667, 0, 1), mat3(0.333333, 0, 0, 0, 0.333333, 0, 0, 0, 0.333333), vec3(3, 3, 3)), 5, Material(vec3(0.7, 1, 0.7), 0, 1.3, 3, -1, -1, -1))
);
