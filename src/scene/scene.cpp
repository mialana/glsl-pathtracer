...
{
    auto matteWhite
        = Material(Color3f(0.725, 0.71, 0.68), 0, -1, DIFFUSE_REFL, nullptr, nullptr, nullptr);
    auto matteRed
        = Material(Color3f(0.63, 0.065, 0.05), 0, -1, DIFFUSE_REFL, nullptr, nullptr, nullptr);
    auto matteGreen
        = Material(Color3f(0.14, 0.45, 0.091), 0, -1, DIFFUSE_REFL, nullptr, nullptr, nullptr);

    // Floor, which is a large white plane
    uPtr<RectangleShape> floor = mkU<RectangleShape>(glm::vec3(0, -2.5, 0),
                                                     glm::vec3(0, 1, 0),
                                                     glm::vec2(5, 5),
                                                     matteWhite);
    ...
    uPtr<RectangleShape> leftWall = mkU<RectangleShape>(glm::vec3(5, 2.5, 0),
                                                        glm::vec3(-1, 0, 0),
                                                        glm::vec2(5, 5),
                                                        matteRed);
    ...
    uPtr<RectangleShape> rightWall = mkU<RectangleShape>(glm::vec3(-5, 2.5, 0),
                                                         glm::vec3(1, 0, 0),
                                                         glm::vec2(5, 5),
                                                         matteGreen);
    ...
    uPtr<RectangleShape> backWall = mkU<RectangleShape>(glm::vec3(0, 2.5, 5),
                                                        glm::vec3(0, 0, -1),
                                                        glm::vec2(5, 5),
                                                        matteWhite);
    ...
    uPtr<RectangleShape> ceiling = mkU<RectangleShape>(glm::vec3(0, 7.5, 0),
                                                       glm::vec3(0, -1, 0),
                                                       glm::vec2(5, 5),
                                                       matteWhite);
    backWall->transform = Transform(Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 1, 1));
    ...
    // Short cube
    uPtr<Box> shortCube = mkU<Box>(glm::vec3(-3.5, -2.5, -0.75),
                                   glm::vec3(-0.5, 0.5, 2.25),
                                   matteWhite);
