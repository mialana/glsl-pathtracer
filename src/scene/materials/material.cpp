...
{
    return "Material(vec3(" + QString::number(albedo.r) + ", " + QString::number(albedo.g) + ", "
           + QString::number(albedo.b) + "), " + QString::number(roughness) + ", "
           + QString::number(eta) + ", " + QString::number(type) + ", "
